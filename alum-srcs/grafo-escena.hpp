...
/*
class BrazoSupDer :  public NodoGrafoEscenaParam{
public:
  BrazoSupDer();
};

class BrazoSupIzq :  public NodoGrafoEscenaParam{
public:
  BrazoSupIzq();
};

class BrazoInfDer:  public NodoGrafoEscenaParam{
public:
  BrazoInfDer();
};

class BrazoInfIzq :  public NodoGrafoEscenaParam{
public:
  BrazoInfIzq();
};
*/
